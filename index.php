...
<body>
  ...
  <div class="content">
    ...
    <div class="container">
                    ...
                    <!--- วนรอบ การ์ดสินค้า -->
                      <?php foreach ($qr_product as $data) { ?>
                        ...
                        <div class="card_items">
                          ...
                          <div class="title">
                            <p><?= $data['name_brand'] ?> <?= $data['model'] ?> <br>color <?=$data['color']?></p>
                          </div>
                          <div class="detail">
                            <span><?=$row_type['type']?></span><br>
                            ...
                            <?php elseif ($row_type['type'] == "KEYBOARD") : ?>
                              <span><?= $data['connector'] ?> / <?= $data['cableLenght'] ?> / <?= $data['volume'] ?> </span>
                            <?php elseif ($row_type['type'] == "MICROPHONE") : ?>
                              <span><?= $data['connector'] ?> / <?= $data['sentivity'] ?> / <?= $data['frequency'] ?> </span>
                            <?php else : ?>
                            <?php endif; ?>
                          </div>
      ...
      <div class="slid-items">
        <div class="content" id="carousel1">
          <div class="carousel">
            <div class="container">
              <div class="wrap">
                <div class="heading">
                ...
                <div class="inner-wrapper">
                  <div class="dotgrid carouselbox swiper">
                    <div class="wrapper swiper-wrapper" id="swip-item">
                      <!-- สไลด items here -->
...
// $type_id = $result['id'];
// $sql_p = "SELECT *,tb_image_product.main_image FROM tb_product 
//     INNER JOIN tb_image_product ON  tb_product.product_id = tb_image_product.product_id
//     WHERE type_id = '$type_id'";
